      ...
      <div className="signup-visual" style={{ backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/images/pic01.jpeg')" }}>
        ...
        <div className="visual-content">
          ...
          <div className="visual-text">
            ...
            >
              Welcome to the family. Your account is verified and ready to go.
            </motion.p>
          </div>
      ...
      <div className="signup-form-section">
        ...
        >
          ...
          <div className="form-header" style={{ textAlign: 'center' }}>
            ...
            <p>You can now access all features of RentUp.</p>
          </div>
          ...
          <div style={{ textAlign: 'center', marginTop: '1rem', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <p className="login-redirect">
              Welcome to the family! Redirecting in 5 seconds...
            </p>
          </div>
        </motion.div>
      </div>
